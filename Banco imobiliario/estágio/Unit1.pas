...
type
  TForm1 = class(TForm)
    ...
    edcasas: TEdit;
    rd2rosa: TRadioButton;
    rd3rosa: TRadioButton;
    rd4rosa: TRadioButton;
    rdhrosa: TRadioButton;
    procedure Button1Click(Sender: TObject);
    procedure Button2Click(Sender: TObject);
    procedure FormCreate(Sender: TObject);
    procedure rd2rosaClick(Sender: TObject);
    procedure rd3rosaClick(Sender: TObject);
    procedure rd4rosaClick(Sender: TObject);
    procedure rdhrosaClick(Sender: TObject);
  private
...
procedure TForm1.rd2rosaClick(Sender: TObject);
begin


tbpropriedades.locate('cod',2,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=2;
tbpropriedades.locate('cod',4,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=2;
tbpropriedades.locate('cod',5,[]);
...
procedure TForm1.rd3rosaClick(Sender: TObject);
begin
tbpropriedades.locate('cod',2,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=3;
tbpropriedades.locate('cod',4,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=3;
tbpropriedades.locate('cod',5,[]);
...
procedure TForm1.rd4rosaClick(Sender: TObject);
begin
tbpropriedades.locate('cod',2,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=4;
tbpropriedades.locate('cod',4,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=4;
tbpropriedades.locate('cod',5,[]);
...
procedure TForm1.rdhrosaClick(Sender: TObject);
begin
tbpropriedades.locate('cod',2,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=5;
tbpropriedades.locate('cod',4,[]);
tbpropriedades.edit;
tbpropriedades.fieldbyname('casas').asinteger:=5;
tbpropriedades.locate('cod',5,[]);
