...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.Menus, Vcl.ComCtrls, cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters,
  ...
  cxPCdxBarPopupMenu, cxPC, dxRibbonSkins, dxSkinsdxRibbonPainter, dxSkinsdxBarPainter, dxBar, cxClasses, dxRibbon, Vcl.ImgList,
...
type
  ...
  private
    ...
    procedure OpenForm(Classe: TFormClass; var Form; sConstruct: Boolean = False);
    procedure CloseForm;
  public
    { Public declarations }
  end;
...
uses untImportarXML,untCadastroUsuarios, untLeituraGuias, untFechamento, untAnaliseGeralGuias, untCadastroGrupoLote,
  untCadastroLote, smGeral, smMensagens, untCadastroClientes, untCadastroServico, untCadastroStatus;
...
procedure TfrmMenuPrincipal.OpenForm(Classe: TFormClass; var Form; sConstruct: Boolean);
var
  TbSheet: TcxTabSheet;
begin
  try
...
procedure TfrmMenuPrincipal.pgPrincCanClose(Sender: TObject; var ACanClose: Boolean);
begin
  ACanClose := False;
  CloseForm;
end;
