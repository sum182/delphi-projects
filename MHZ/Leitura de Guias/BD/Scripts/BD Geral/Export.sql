/******************************************************************************/
/****         Generated by IBExpert 2007.05.03 21/10/2014 13:30:15         ****/
/******************************************************************************/
...
SET GENERATOR GEN_GUIAS_CABECALHO TO 9;

CREATE GENERATOR GEN_GUIAS_DETALHE;
SET GENERATOR GEN_GUIAS_DETALHE TO 496;
...
SET GENERATOR GEN_USUARIO TO 13;
...
CREATE TABLE GUIAS (
    ...
    SEQUENCIALTRANSACAO          VARCHAR(50),
    DATAREGISTROTRANSACAO        VARCHAR(50),
    HORAREGISTROTRANSACAO        VARCHAR(50),
    CODIGOPRESTADORNAOPERADORA   VARCHAR(50),
    REGISTROANS                  VARCHAR(50),
    VERSAOPADRAO                 VARCHAR(50),
    NUMEROLOTE                   VARCHAR(50),
    REGISTROANS2                 VARCHAR(50),
    DATAEMISSAOGUIA              VARCHAR(50),
    NUMEROGUIAPRESTADOR          VARCHAR(50),
    DADOSAUTORIZACAO             VARCHAR(50),
    NUMEROCARTEIRA               VARCHAR(50),
    NOMEBENEFICIARIO             VARCHAR(50),
    NOMEPLANO                    VARCHAR(50),
    CODIGOPRESTADORNAOPERADORA3  VARCHAR(50),
    NOMECONTRATADO               VARCHAR(50),
    NOMEPROFISSIONAL             VARCHAR(50),
    SIGLACONSELHO                VARCHAR(50),
    NUMEROCONSELHO               VARCHAR(50),
    UFCONSELHO                   VARCHAR(50),
    CODIGOPRESTADORNAOPERADORA4  VARCHAR(50),
    NOMECONTRATADO5              VARCHAR(50),
    CARATERATENDIMENTO           VARCHAR(50),
    TIPOSAIDA                    VARCHAR(50),
    TIPOATENDIMENTO              VARCHAR(50),
    CODIGO                       VARCHAR(50),
    TIPOTABELA                   VARCHAR(50),
    DESCRICAO                    VARCHAR(50),
    DATA                         VARCHAR(50),
    QUANTIDADEREALIZADA          VARCHAR(50),
    VALOR                        VARCHAR(50),
    VALORTOTAL                   VARCHAR(50),
    TOTALGERAL                   VARCHAR(50),
    "HASH"                       VARCHAR(50)
);
