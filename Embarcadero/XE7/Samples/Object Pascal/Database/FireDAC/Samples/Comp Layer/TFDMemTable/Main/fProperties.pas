...
type
  ...
  public
    { Public declarations }
    procedure LoadMemTable(AFileName: String; ADS: TDataSet);
  end;
...
{ Fill data                                                                    }
{------------------------------------------------------------------------------}
procedure TfrmProperties.LoadMemTable(AFileName: String; ADS: TDataSet);
begin
  ...
  begin
    ADS.Open;
    FDMemTable1.CopyDataSet(ADS, [coStructure, coIndexesCopy,
